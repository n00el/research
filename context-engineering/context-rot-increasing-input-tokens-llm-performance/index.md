...
**Author:** Kelly Hong (Researcher), Anton Troynikov (Cofounder, Advisor), Jeff Huber (Cofounder, CEO) - Chroma
**Date:** July 14, 2025
...
![Claude Sonnet 4, GPT-4.1, Qwen3-32B, and Gemini 2.5 Flash on Repeated Words Task](image-01-header-plot.png)

![Hero Plot](image-02-hero-plot.png)
...
![Example Needle in a Haystack (NIAH) Setup](image-03-niah-lexical.png)
...
![Example Needle in a Haystack (NIAH) Setup with Lexical Matching](image-05-niah-lexical-2.png)
...
![Comparison - Distractor vs. Irrelevant Context](image-06-distractor-irrelevance.png)
...
3. Use UMAP [14] for dimensionality reduction with the following parameters: n_neighbors=30, min_dist=0.05, n_components=50, random_state=42
4. Use HDBSCAN [15] to create clusters with the following parameters: min_cluster_size=10, min_samples=15
...
![NIAH: Needle-Question Similarity (thinking/non-thinking modes of the same model are treated separately) - arXiv haystack/arXiv needles. High Performance: upper 33% performance. Blue: high-similarity needles (upper 50% similarity). Red: low-similarity needles (lower 50% similarity)](image-07-nq-sim-arxiv.png)
...
>
> Distractors:
> 1. "The best writing tip I received from my college professor was to write everyday."
> 2. "The worst writing advice I got from my college classmate was to write each essay in five different styles."
> 3. "The best writing advice I got from my classmate was to write each essay in three different styles, this was back in high school."
> 4. "I thought the best writing advice I got from my college classmate was to write each essay in four different styles, but not anymore."
...
![Impact of Distractors - Three Conditions](image-08-distractors-var.png)
...
![Impact of Distractors: Performance by Number of Distractors - arXiv haystack/PG essay needles](image-09-distractors-num.png)
...
![Impact of Distractors: Performance by Individual Distractors - arXiv haystack/PG essay needles](image-10-distractors-ind.png)
...
![Impact of Distractors: Failure Analysis - arXiv haystack/PG essay needles](image-11-hallucinations.png)
...
![Needle-Haystack Similarity: Experimental Setup](image-12-needle-haystack.png)
...
![Needle-Haystack Similarity Results](image-13-needle-haystack-2.png)
...
![Haystack Structure: Sample Experimental Setup](image-14-nh2.png)
...
![Haystack Structure: Averaged Performance Across 18 Models for Original vs Shuffled Haystacks](image-15-structure-2.png)
...
![LongMemEval - Examples by Question Type](image-25-longmemeval-ex.png)
...
![LongMemEval Results - Claude Family](image-23-longmemeval-claude.png)
...
![LongMemEval - Claude Sonnet 4 (non-thinking) on full prompt containing the dates](image-24-longmemeval-claude-comparison.png)
...
![LongMemEval Results - GPT Family](image-27-longmemeval-gpt.png)

![LongMemEval Results - Gemini Family](image-26-longmemeval-gemini.png)

![LongMemEval Results - Qwen Family](image-28-longmemeval-qwen.png)
...
![Repeated Words - Claude Family](image-16-claude-line-plot.png)
...
![Repeated Words: Position Accuracy - Claude Family](image-17-claude-position-accuracy.png)
...
![Repeated Words: Word Count Difference - Claude Family](image-18-claude-num-words.png)
...
![Repeated Words - GPT Family](image-19-gpt-line-plot.png)
...
![Repeated Words: Word Count Difference - GPT-4 Turbo](image-20-gpt-4-turbo.png)
...
![Repeated Words - Gemini Family](image-21-gemini-line-plot.png)
...
![Repeated Words - Qwen Family](image-22-qwen-line-plot.png)

We only observe non-attempts with Qwen3-8B, which make up 4.21% of tasks. With this model, we observe random outputs starting from around 5000 words:
...
[1] Kamradt, G. (2023). Needle In A Haystack - Pressure Testing LLMs [GitHub Repository].

[2] Wu, D., Wang, H., Yu, W., Zhang, Y., Chang, K.-W., and Yu, D. (2025). LongMemEval: Benchmarking Chat Assistants on Long-Term Interactive Memory. arXiv preprint arXiv:2410.10813.

[3] Gemini Team, Georgiev, P., Lei, V. I., Burnell, R., Bai, L., Gulati, A., Tanzer, G., Vincent, D., Pan, Z., Wang, S., et al. (2024). Gemini 1.5: Unlocking multimodal understanding across millions of tokens of context. arXiv preprint arXiv:2403.05530.

[4] OpenAI, Kumar, A., Yu, J., Hallman, J., Pokrass, M., Goucher, A., Ganesh, A., Cheng, B., McKinzie, B., Zhang, B., Koch, C., et al. (2025). Introducing GPT-4.1 in the API.

[5] Meta AI, (2025). The Llama 4 herd: The beginning of a new era of natively multimodal AI innovation.

[6] Modarressi, A., Deilamsalehy, H., Dernoncourt, F., Bui, T., Rossi, R. A., Yoon, S., and Schutze, H. (2025). NoLiMa: Long-Context Evaluation Beyond Literal Matching. arXiv preprint arXiv:2502.05167.

[7] Fu, H. Y., Shrivastava, A., Moore, J., West, P., Tan, C., and Holtzman, A. (2025). AbsenceBench: Language Models Can't Tell What's Missing. arXiv preprint arXiv:2506.11440.

[8] Vodrahalli, K., Ontanon, S., Tripuraneni, N., Xu, K., Jain, S., Shivanna, R., Hui, J., Dikkala, N., Kazemi, M., Fatemi, B., et al. (2024). Michelangelo: Long Context Evaluations Beyond Haystacks via Latent Structure Queries. arXiv preprint arXiv:2409.12640.

[9] openai. (2025). mrcr [Dataset]. Hugging Face.

[10] openai. (2025). graphwalks [Dataset]. Hugging Face.

[11] Shi, F., Chen, X., Misra, K., Scales, N., Dohan, D., Chi, E., Scharli, N., and Zhou, D. (2023). Large Language Models Can Be Easily Distracted by Irrelevant Context. arXiv preprint arXiv:2302.00093.

[12] jamescalam. (2024). ai-arxiv2 [Dataset]. Hugging Face.

[13] Peng, B., Quesnelle, J., Fan, H., and Shippole, E. (2023). YaRN: Efficient Context Window Extension of Large Language Models. arXiv preprint arXiv:2309.00071.

[14] McInnes, L., Healy, J., and Melville, J. (2020). UMAP: Uniform Manifold Approximation and Projection for Dimension Reduction. arXiv preprint arXiv:1802.03426.

[15] Campello, R. J. G. B., Moulavi, D., and Sander, J. (2013). Density-Based Clustering Based on Hierarchical Density Estimates. In Pei, J., Tseng, V. S., Cao, L., Motoda, H., and Xu, G. (Eds.), Advances in Knowledge Discovery and Data Mining (PAKDD 2013), Lecture Notes in Computer Science, vol 7819. Springer, Berlin, Heidelberg.

## Appendix

Cleaned LongMemEval datasets and needles/distractors used can be downloaded from the original source.

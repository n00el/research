...
**Author:** Anish Moonka (@AnishA_Moonka)
**Date:** March 15, 2026
**Source:** https://x.com/AnishA_Moonka/status/2033128021092073502
**Stats:** 1.17M views, 2,735 likes, 407 retweets, 10,676 bookmarks, 71 replies
...
1. Energy. You need electricity to power the computers. Lots of it.
1. Chips. You need specialised processors to do the math. These are not your laptop's brain.
1. Cloud. You need massive warehouses full of these chips, connected by insanely fast networks.
1. Models. You need the actual AI software, the "brain" that learns patterns from data.
1. Applications. You need products people actually use. ChatGPT. Google Search. Your bank's fraud detector.

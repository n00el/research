...
**Stats:** 4,402 likes | 469 retweets | 59 replies | 20,856 bookmarks | 2,917,055 views
...
6. Made a full guide on how to use Cowork here.
...
1. Open any Claude chat (on [claude.ai](https://claude.ai) or Cowork).
...
2. Go to [claude.com/plugins](https://claude.com/plugins).
...
1. Go to [claude.ai](https://claude.ai) and log in (Pro or Team plan required).

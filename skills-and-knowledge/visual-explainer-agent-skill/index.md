# visual-explainer: Agent Skill That Turns Complex Terminal Output into Styled HTML

**Author:** nicobailon
**Date:** 2026-02-16 (created), updated 2026-03-08
**Source:** https://github.com/nicobailon/visual-explainer
**Stats:** 5,893 stars, 403 forks, MIT License, HTML (97.6%) / Shell (2.4%)

---

![visual-explainer banner](image-1.png)

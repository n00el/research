...
**Stats:** 16 replies, 65 retweets, 496 likes, 853 bookmarks, 281K views
...
So when we started building [Intent](https://www.augmentcode.com/product/intent), the question we kept circling was: what if the spec wasn't something you maintained? What if it maintained itself?
...
If agents can write code, they can update the plan. [Let them.](https://www.augmentcode.com/product/intent)
